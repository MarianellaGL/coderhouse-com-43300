...
document.addEventListener("DOMContentLoaded", function () {
  ...
  buttonEliminar.classList.add("clear-favorites-btn");
  buttonEliminar.textContent = "Eliminar Favoritos";
  document.body.appendChild(buttonEliminar);

  const clearBtnFavorites = document.querySelector(".clear-favorites-btn");

  clearBtnFavorites.addEventListener("click", deleteFavorites);
